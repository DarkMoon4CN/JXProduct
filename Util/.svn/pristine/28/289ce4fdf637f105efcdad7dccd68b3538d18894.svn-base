...
namespace JXUtil
{
    public class CommUtil
    {
        ...
        /// <returns></returns>
        public static string SendPostRequest(string url, string paras, string encodetype)
        {
            ...
            using (StreamReader reader = new StreamReader(req.GetResponse().GetResponseStream(), encode))
            {
        ...
        /// <param name="url">地址</param>
        /// <param name="encodetype">编码</param>
        /// <param name="header">头文件信息</param>
        /// <returns></returns>
        public static string SendGetWebRequest(string url, string encodetype, IDictionary<string, string> header)
        {
            string result = string.Empty;
