...
namespace JXProduct.Component.SQLServerDAL
{
    public class ManufacturerDAL
    {
        ...
        /// <returns></returns>
        internal int Manufacturer_Insert(ManufacturerInfo manufacterInfo)
        {
            string sqlCommand = "Manufacturer_Insert";
        ...
        internal bool Manufacturer_Update(ManufacturerInfo manufacterInfo)
        {
            string sqlCommand = "Manufacturer_Update";
            DbCommand dbCommand = dbw.GetStoredProcCommand(sqlCommand);
        ...
        /// </summary>
        /// <param name="mid">Manufacturer Main ID</param>
        /// <returns>ManufacturerInfo get from Manufacturer table.</returns>	
        ...
        /// <param name="mid">Manufacturer Main ID</param>
        /// <returns>true:成功 false:失败</returns>	
        internal bool Manufacturer_Delete(int manuID)
        {
            string sqlCommand = "Manufacturer_Delete";
            DbCommand dbCommand = dbw.GetStoredProcCommand(sqlCommand);
        ...
        /// <summary>
        /// 从 IDataReader 中恢复Manufacturer对象
        /// </summary>
