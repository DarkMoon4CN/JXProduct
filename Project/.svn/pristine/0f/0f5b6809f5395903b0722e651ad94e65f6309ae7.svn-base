namespace JXProduct.Component.SQLServerDAL
{
    ...
    internal class ProductDAL
    {
        ...
        public int Product_AddNew(ProductInfo productInfo)
        {
            ...
            dbw.AddInParameter(dbCommand, "FinanceType", DbType.String, productInfo.FinanceType);
        ...
        public bool Product_Update(ProductInfo info)
        {
            ...
            dbw.AddInParameter(cmd, "FinanceType", DbType.String, info.FinanceType);
        ...
        private ProductInfo RecoverModel(IDataReader read)
        {
            ...
            info.FinanceType = read["FinanceType"].ToString();
