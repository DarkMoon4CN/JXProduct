...
namespace JXProduct.Component.Model
{
    public class ProductInstructionsInfo
    {
        ...
        ///用法用量
        /// </summary>
        public string InsDosage { get; set; }
        ...
        ///贮存
        /// </summary>
        public string StorageMothod { get; set; }
        ...
        public override string ToString()
        {
            ...
            if (!string.IsNullOrWhiteSpace(this.InsDosage))
                s.Append("用法用量:" + this.InsDosage + split);
            ...
            if (!string.IsNullOrWhiteSpace(this.StorageMothod))
                s.Append("贮存:" + this.StorageMothod + split);
        ...
        public string ToProductParameter(ProductInfo p)
        {
            ...
            if (!string.IsNullOrWhiteSpace(this.TradeName))
                s.Append("商品名:" + this.TradeName + split);
            if (!string.IsNullOrWhiteSpace(this.CADN))
                s.Append("通用名:" + p.CADN + split);
            //if (!string.IsNullOrWhiteSpace(p.BrandName))
            //    s.Append("品牌名:" + p.BrandName + split);
            if (!string.IsNullOrWhiteSpace(this.Specifications))
                s.Append("规格:" + this.Specifications + split);
            if (!string.IsNullOrWhiteSpace(this.Weight))
                s.Append("重量:" + this.Weight + split);
