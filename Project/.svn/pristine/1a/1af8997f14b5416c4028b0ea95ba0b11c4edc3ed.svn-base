...
namespace JXProduct.Component.Model
{
    ...
    public class ProductInfo
    {
        ...
        /// <summary>
        /// 启用推算类型  推测ProductType,Abbreviation
        /// </summary>
        public void ReckonType()
        {
            if (this.ParameterType > 0)
            {
                ...
                if (this.DrugType == 2 || this.DrugType == 3)
                {
                    this.ProductType = 1;
                }
                ...
                {
                    case 1:
                        this.ProductType = 0; break;
                    case 2:
                        this.ProductType = 3; break;
                }

                this.Abbreviation = "QT";
                switch (ParameterType)
                {
                    case 2: this.Abbreviation = "QX"; break;
                    case 1:
                        {
                            switch (DrugType)
                            {
                                case 1: this.Abbreviation = "RX"; break;
                                case 2:
                                case 3:
                                    this.Abbreviation = "OTC";
                                    break;
                                default: this.Abbreviation = "RX"; break;
                            }
                        }
                        break;
                }
            }
            this.ChineseName = this.CADN;
        }
    }
