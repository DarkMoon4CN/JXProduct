...
namespace JXProduct.Component.BLL
{
    public class ProductBLL
    {
        ...
        {
            return dal.Product_PriceEdit(productid, marketprice, tradeprice, mobileprice, longName);
        }
        ...
        {
            return dal.Product_SEOEdit(productid, title, keywords, metakeywords, metadescription, updater);
        }
