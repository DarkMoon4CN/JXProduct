namespace JXAPI.Component.SQLServerDAL
{
    ...
    public class ProductDAL
    {
        ...
        DatabaseTypeUpdate dbType_Update = DatabaseTypeUpdate.dbr_Product;
        DatabaseTypeAdd dbType_Add = DatabaseTypeAdd.dbr_Product;
        ...
        public DataTable GetAddList(int ID, string updateTime, int pageSize, string tableName)
        {
            try
            {
                ...
                switch (tableName.ToLower())
                {
                    case "product":
                    case "jxorderproduct":
                        sqlCommand.Append(string.Format(@" p.*,m.Manufacturer,b.ChineseName AS BrandName,ISNULL((SELECT SUM(UsableStock) FROM JXProductStock.dbo.ProductStock WHERE ProductCode=p.ProductCode),0) AS Stock 
                        ...
                        dbType_Add = DatabaseTypeAdd.dbr_Product;
                        break;
                    ...
                    case "jxorderproductrelated":
                        ...
                        break;
                    case "productstock":
                        sqlCommand.Append(string.Format(" * FROM ProductStock WHERE HouseID=9 "));
                        ...
                        dbType_Add = DatabaseTypeAdd.dbr_ProductStock;
                        break;
                    case "manufacter":
                    ...
                    case "sale":
                        ...
                        dbType_Add = DatabaseTypeAdd.dbr_Marketing;
                        break;
                    case "productall":
                        sqlCommand.Append(string.Format(" * FROM {0} WHERE 1=1  ", tableName));
                        sqlCommand.Append(updateTimeStr);
            ...
            {
                myLog.ErrorFormat("ProductDAL 查询需要添加的{0}表失败,ID:{1},异常信息:{2}", tableName, ID, ex.Message);
                return null;
            }
        }
        ...
        public DataTable GetUpdateList(int MaxID, int NowID, string updateTime, int pageSize, string tableName)
        {
            try
            {
                ...
                switch (tableName.ToLower())
                {
                    ...
                    case "jxorderproduct":
                        ...
                        dbType_Update = DatabaseTypeUpdate.dbr_Product;
                        break;
                    case "productactivity":
                        sqlCommand.AppendFormat(@"a.*,p.ProductCode,p.MarketPrice,p.TradePrice,p.MobilePrice,p.CostPrice FROM 
                            ProductActivity as a inner join Product as p on a.ProductID = p.ProductID where 1=1 ");
                    ...
                    case "productstock":
                        ...
                        dbType_Update = DatabaseTypeUpdate.dbr_ProductStock;
                        break;
                    case "manufacter":
                        sqlCommand.Append(string.Format(" * FROM Manufacturer WHERE 1=1 "));
                        if (!string.IsNullOrEmpty(updateTime))
                    ...
                    case "sale":
                        ...
                        dbType_Update = DatabaseTypeUpdate.dbr_Marketing;
                        break;
                    case "productall":
                        sqlCommand.Append(string.Format(" * FROM {0} WHERE 1=1 ", tableName));
                        sqlCommand.Append(updateTimeStr);
                    ...
                    case "jxyxproduct":
                        ...
                        dbType_Update = DatabaseTypeUpdate.dbr_YX;
                        break;
                }
                DataSet dSet = new DataSet();
                switch (dbType_Update)
                {
                    case DatabaseTypeUpdate.dbr_Product:
                        var dbCommand1 = dbr_Product.GetSqlStringCommand(sqlCommand.ToString());
                        dSet = dbr_Product.ExecuteDataSet(dbCommand1);
                        break;
                    case DatabaseTypeUpdate.dbr_Marketing:
                        var dbCommand2 = dbr_Marketing.GetSqlStringCommand(sqlCommand.ToString());
                        dSet = dbr_Marketing.ExecuteDataSet(dbCommand2);
                        break;
                    case DatabaseTypeUpdate.dbr_YX:
                        var dbCommand3 = dbr_YX.GetSqlStringCommand(sqlCommand.ToString());
                        dSet = dbr_YX.ExecuteDataSet(dbCommand3);
                        break;
                    case DatabaseTypeUpdate.dbr_ProductStock:
                        var dbCommand4 = dbr_ProductStock.GetSqlStringCommand(sqlCommand.ToString());
                        dSet = dbr_ProductStock.ExecuteDataSet(dbCommand4);
                        break;
                }
            ...
            {
                myLog.ErrorFormat("ProductDAL {0}表 ID:{1},异常信息:{2}", tableName, NowID, ex.Message);
                return null;
            }
        }
